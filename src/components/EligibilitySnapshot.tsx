...
const PATHWAY_THRESHOLDS: Record<string, PathwayThreshold> = {
  ...
  "eu-blue-card": {
    minimumIncomeIndex: 2,
    minimumSavingsIndex: 1,
    allowedEmployment: ["Remote employee", "Business owner"],
    excludedPassports: ["EU / EEA"],
    notes: "EU Blue Card requires a recognised degree and a job offer meeting the salary threshold.",
  },
  "skilled-worker-residence": {
    ...
    allowedEmployment: ["Remote employee"],
    excludedPassports: ["EU / EEA"],
    notes: "Requires recognised vocational training or a degree and a concrete job offer.",
  },
  "critical-skills": {
    minimumIncomeIndex: 2,
    minimumSavingsIndex: 1,
    allowedEmployment: ["Remote employee"],
    excludedPassports: ["EU / EEA"],
    notes: "Requires a job offer on the Critical Skills Occupations List with a minimum salary of 38,000 EUR.",
  },
  "general-employment": {
    minimumIncomeIndex: 2,
    minimumSavingsIndex: 1,
    allowedEmployment: ["Remote employee"],
    excludedPassports: ["EU / EEA"],
    notes: "Requires a job offer with a minimum salary of 34,000 EUR and a labour market needs test.",
  },
  "skilled-independent-189": {
    minimumIncomeIndex: 2,
    minimumSavingsIndex: 2,
    notes: "Australia uses a points-based system requiring detailed assessment. Bracket guidance is approximate.",
  },
  "skilled-nominated-190": {
    minimumIncomeIndex: 2,
    minimumSavingsIndex: 2,
    notes: "Requires state or territory nomination. Australia uses a points-based system requiring detailed assessment.",
  },
  ltr: {
    minimumIncomeIndex: 3,
    minimumSavingsIndex: 2,
