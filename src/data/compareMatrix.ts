...
const ALL_ROWS: CompareRow[] = [
  ...
  },
  {
    ...
    values: {
      portugal: "Yes — PR after 5 years; citizenship currently 5 years, but May 2026 reform raises it to 7 (CPLP) / 10 (others) once published in the Diário da República",
  ...
  },
  {
    ...
    values: {
      ...
      "united-kingdom": "Primary route — employer must be licensed sponsor. General Skilled Worker minimum salary £41,700 (since July 2025; previously £38,700 from April 2024).",
  ...
  },
  {
    ...
    values: {
      ...
      "united-kingdom": "Skilled Worker: £41,700/yr salary (since July 2025; or going rate, whichever is higher). Global Talent: no minimum.",
