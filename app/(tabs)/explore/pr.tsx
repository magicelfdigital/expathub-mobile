...
const COUNTRIES = [
  { slug: "canada", name: "Canada", label: "Express Entry grants permanent residency immediately", pathwayKey: "express-entry" },
  { slug: "costa-rica", name: "Costa Rica", label: "Rentista/Pensionado — permanent residency after 3 years", pathwayKey: "rentista" },
  { slug: "ecuador", name: "Ecuador", label: "Rentista/Jubilado — permanent residency after ~2 years", pathwayKey: "rentista" },
  { slug: "malta", name: "Malta", label: "GRP — renewable residency (no permanent residency pathway)", pathwayKey: "grp" },
  { slug: "panama", name: "Panama", label: "FNV — permanent residency after 2-year provisional period", pathwayKey: "friendly-nations" },
  { slug: "portugal", name: "Portugal", label: "D7/D8 — permanent residency after 5 years, citizenship at 5", pathwayKey: "d7" },
  { slug: "spain", name: "Spain", label: "NLV — permanent residency after 5 years, citizenship at 10", pathwayKey: "nlv" },
  { slug: "united-kingdom", name: "United Kingdom", label: "Skilled Worker — ILR after 5 years", pathwayKey: "skilled-worker" },
];
...
export default function PRScreen() {
  ...
  return (
    <Screen>
      ...
      >
        <View style={s.header}>
          <Text style={s.h1}>Path to permanent residency</Text>
          <Text style={s.explainer}>
            Not every visa leads to permanent residency. Some are dead ends that force you to leave or restart. Tap any option to see the full pathway guide and Decision Brief covering permanent residency timelines.
          </Text>
        </View>
