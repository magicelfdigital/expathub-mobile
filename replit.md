...
- **Navigation**: Tab-based layout (Home, Explore, Community) with nested Stack navigators for country details; Countries tab hidden (`href: null`) since country list is merged into Home screen; subscription flow as a modal.
